...
data_dt[, Voltage := as.numeric(Voltage)]
...
data_dt[, Global_reactive_power := as.numeric(Global_reactive_power)]
...
# mar: x-axis, y-axis, top and right margins
